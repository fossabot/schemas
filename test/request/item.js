...
exports.testItemCreateSchema = () => {
	const isValid = ajv.validate(schemas.request.item.create.body, {
		lineId: 'line-id',
		ids: ['id', 'id1']
	})
...
exports.testQuerystringGet = () => {
	const isValid = ajv.validate(schemas.request.item.get.querystring, {
		existence: true
	})
...
exports.testQuerystringRandom = () => {
	const isValid = ajv.validate(schemas.request.item.random.querystring, {
		productId: 'product',
		sku: 'sku'
	})
