...
exports.testSupplyChainEmployeeSchema = () => {
	const isValid = ajv.validate(schemas.request.supplychain.node.step.employee.single, {
		id: 'id'
	})
...
exports.testSupplyChainStepSchema = () => {
	const isValid = ajv.validate(schemas.request.supplychain.node.step.single, {
		pictures: [
			{
				id: 'FILE-ID'
			}
...
exports.testSupplyChainCreateSchema = () => {
	const isValid = ajv.validate(schemas.request.supplychain.create.body, {
		name: 'name',
...
exports.testSupplyChainUpdateSchema = () => {
	const isValid = ajv.validate(schemas.request.supplychain.update.body, {
		name: 'name update',
		nodes: [
			{
				id: 'node-ID',
...
exports.testQuerystringList = () => {
	const isValid = ajv.validate(schemas.request.supplychain.list.querystring, {
		dropdownlist: true
	})
