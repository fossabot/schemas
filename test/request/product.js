...
exports.testProductVariationSchema = () => {
	const isValid = ajv.validate(schemas.request.product.variation.single, {
		id: 'variation-id',
		sku: 'sku'
	})
...
exports.testProductCreateSchemaWithoutAttributes = () => {
	const isValid = ajv.validate(schemas.request.product.create.body, {
...
exports.testProductUpdateSchema = () => {
	const isValid = ajv.validate(schemas.request.product.update.body, {
		name: 'product update'
	})
...
exports.testQuerystringList = () => {
	const isValid = ajv.validate(schemas.request.product.list.querystring, {
		dropdownlist: true
	})
